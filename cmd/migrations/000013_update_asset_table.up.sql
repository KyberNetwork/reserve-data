ALTER TABLE assets ADD COLUMN IF NOT EXISTS "price_eth_amount" FLOAT DEFAULT 1;
ALTER TABLE assets ADD COLUMN IF NOT EXISTS "exchange_eth_amount" FLOAT DEFAULT 1;
