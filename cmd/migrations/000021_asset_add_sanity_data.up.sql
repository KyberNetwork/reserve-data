ALTER TABLE assets ADD COLUMN sanity_threshold FLOAT DEFAULT 0;
ALTER TABLE assets ADD COLUMN sanity_rate_provider TEXT;
ALTER TABLE assets ADD COLUMN sanity_rate_path TEXT[] DEFAULT '{}'::TEXT[];
