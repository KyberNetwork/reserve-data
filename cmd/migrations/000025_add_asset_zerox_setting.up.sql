ALTER TABLE assets ADD COLUMN ref_eth_amount FLOAT DEFAULT 0;
ALTER TABLE assets ADD COLUMN eth_step FLOAT DEFAULT 0;
ALTER TABLE assets ADD COLUMN max_eth_size_buy FLOAT default 0;
ALTER TABLE assets ADD COLUMN max_eth_size_sell FLOAT default 0;
ALTER TABLE assets ADD COLUMN zerox_enabled BOOLEAN default FALSE;
...
CREATE OR REPLACE FUNCTION new_asset(_symbol assets.symbol%TYPE,
                                     ...
                                     _ref_eth_amount assets.ref_eth_amount%TYPE,
                                     _eth_step assets.eth_step%TYPE,
                                     _max_eth_size_buy assets.max_eth_size_buy%TYPE,
                                     _max_eth_size_sell assets.max_eth_size_sell%TYPE,
                                     _zerox_enabled assets.zerox_enabled%TYPE
)
    RETURNS int AS
$$
DECLARE
